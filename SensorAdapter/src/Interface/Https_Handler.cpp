...
int Https_Handler::httpsPOSTCallback(const char *url, const char *payload)
{
     return 1;
}
...
char szContentType2[] = "application/x-www-form-urlencoded\0";
          ...
          const char *upload_data, size_t *upload_data_size, void **con_cls)
{
	...
	if(strcmp(method, "GET") == 0)
     ...
     else if(strcmp(method, "POST") == 0)
     {
          ...
          MHD_replace_connection_value (connection, MHD_HEADER_KIND, MHD_HTTP_HEADER_CONTENT_TYPE, szContentType2);
          ...
          if (*upload_data_size != 0){
               ...
               value = ((Https_Handler *)cls)->httpsPOSTCallback(url /*const char * */, upload_data /*const char * */);
               *upload_data_size = 0;
